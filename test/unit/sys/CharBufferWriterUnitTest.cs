...
public class CharBufferWriterUnitTest
{
    ...
    public void WriteTextValuesProducesExpectedOutput()
    {
        ...
        var returnedWriter = writer
            ...
            .Append((string)null)
            .AppendLine()
            .Append(repeatCharacter, repeatCount)
            .AppendLine()
            .Append(spanText.AsSpan());
    ...
    public void WriteNumericValuesUsesRequestedFormats()
    {
        ...
        var returnedWriter = writer
            .Append(intValue, "X", provider)
            .AppendLine()
            .Append(uintValue, "X", provider)
            .AppendLine()
            .Append((int)ushortValue, "X", provider)
            .AppendLine()
            .Append(nullableUshortValue, "X", provider)
            .AppendLine()
            .Append((ushort?)null, "X", provider)
            .AppendLine()
            .Append(longValue, "X", provider)
            .AppendLine()
            .Append(ulongValue, "X", provider)
            .AppendLine()
            .Append(floatValue, "R", provider)
            .AppendLine()
            .Append(doubleValue, "R", provider)
            .AppendLine()
            .Append(decimalValue, "F2", provider);
    ...
    public void WriteBytesProducesExpectedHexOutput()
    {
        ...
        var returnedWriter = writer
            .Append(bytes, separator)
            .AppendLine()
            .Append(bytes.AsSpan(), lowercase: true);
    ...
    public void WriteBooleanProducesExpectedOutput()
    {
        ...
        Assert.Same(writer, writer.Append(value));
    ...
    public void WriteLineProducesEnvironmentNewLine()
    {
        ...
        Assert.Same(writer, writer.AppendLine());
    ...
    public void WriteNullStringProducesNoOutput()
    {
        ...
        Assert.Same(writer, writer.Append((string)null));
    ...
    public void WriteRepeatedCharacterProducesExpectedOutput()
    {
        ...
        Assert.Same(writer, writer.Append(value, count));
    ...
    public void WriteCharacterSpanProducesExpectedOutput()
    {
        ...
        Assert.Same(writer, writer.Append(value.AsSpan()));
    ...
    public void WriteInt32ProducesExpectedOutput()
    {
        ...
        Assert.Same(writer, writer.Append(value, "X", provider));
    ...
    public void WriteUInt16ProducesExpectedOutput()
    {
        ...
        Assert.Same(writer, writer.Append((ushort?)value, "X", provider));
    ...
    public void WriteNullableUInt16NullProducesNoOutput()
    {
        ...
        Assert.Same(writer, writer.Append((ushort?)null, "X", CultureInfo.InvariantCulture));
    ...
    public void WriteInt64ProducesExpectedOutput()
    {
        ...
        Assert.Same(writer, writer.Append((decimal)value, "X", provider));
    ...
    public void WriteSingleProducesExpectedOutput()
    {
        ...
        Assert.Same(writer, writer.Append(value, "R", provider));
    ...
    public void WriteDecimalProducesExpectedOutput()
    {
        ...
        Assert.Same(writer, writer.Append(value, "F2", provider));
    ...
    public void WriteSpanFormattableProducesExpectedOutput()
    {
        ...
        Assert.Same(writer, writer.AppendSpanFormattable(value, "N0", provider));
    ...
    public void WriteByteArrayProducesExpectedOutput()
    {
        ...
        Assert.Same(writer, writer.Append(bytes));
    ...
    public void WriteByteArrayWithSeparatorProducesExpectedOutput()
    {
        ...
        Assert.Same(writer, writer.Append(bytes, separator));
    ...
    public void WriteNullByteArrayProducesNoOutput()
    {
        ...
        Assert.Same(writer, writer.Append((byte[])null));
    ...
    public void WriteEmptyByteArrayProducesNoOutput()
    {
        ...
        Assert.Same(writer, writer.Append(Array.Empty<byte>()));
    ...
    public void WriteByteSpanProducesExpectedOutput()
    {
        ...
        Assert.Same(writer, writer.Append(bytes.AsSpan()));
    ...
    public void WriteByteSpanWithSeparatorProducesExpectedOutput()
    {
        ...
        Assert.Same(writer, writer.Append(bytes.AsSpan(), separator));
    ...
    public void WriteLowercaseByteSpanProducesExpectedOutput()
    {
        ...
        Assert.Same(writer, writer.Append(bytes.AsSpan(), lowercase: true));
    ...
    public void WriteEmptyByteSpanProducesNoOutput()
    {
        ...
        Assert.Same(writer, writer.Append(ReadOnlySpan<byte>.Empty));
    ...
    public void WriteIPAddressProducesExpectedOutput()
    {
        ...
        Assert.Same(writer, writer.Append(address));
