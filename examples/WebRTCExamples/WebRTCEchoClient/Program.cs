...
namespace demo
{
    class Program
    {
        ...
        static async Task Main()
        {
            ...
            testPattern.OnVideoSourceRawSpanSample += static (uint durationMilliseconds, int width, int height, ReadOnlySpan<byte> sample, VideoPixelFormatsEnum pixelFormat) =>
            {
                if (_isFormActivated)
                {
