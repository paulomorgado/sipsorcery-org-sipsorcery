...
public partial class RTCPTWCCFeedback : IByteSerializable
{
    ...
    {
        builder
            .Append("TWCC Feedback: SenderSSRC=")
            .Append(SenderSSRC)
            .Append(", MediaSSRC=")
            .Append(MediaSSRC)
            .Append(", BaseSeq=")
            .Append(BaseSequenceNumber)
            .Append(", StatusCount=")
            .Append(PacketStatusCount)
            .Append(", RefTime=")
            .Append(ReferenceTime)
            .Append(" (1/64 sec), FbkPktCount=")
            .Append(FeedbackPacketCount)
            .Append(", PacketStatuses=[");
        ...
        for (var i = 0; i < PacketStatuses.Count; i++)
        {
            ...
            builder
                .Append("Seq:")
                .Append(ps.SequenceNumber)
                .Append('(')
                .Append(ps.Status.ToStringFast());

            if (ps.Delta.HasValue)
            {
                builder.Append(",Δ:").Append(ps.Delta.Value);
            }
