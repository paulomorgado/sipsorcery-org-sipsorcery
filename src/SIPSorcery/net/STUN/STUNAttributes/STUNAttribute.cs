...
public partial class STUNAttribute : IByteSerializable
{
    ...
    {
        builder
            .Append("STUN Attribute: ")
            .Append(AttributeType.ToStringFast())
            .Append(", ");
        WriteValueToString(builder);
        builder.Append('.');
    }

    private protected virtual void WriteValueToString(StringBuilder builder)
    {
        builder
            .Append(Value.Span)
            .Append(", length=")
