...
public partial class STUNChangeRequestAttribute : STUNAttribute
{
    ...
    private protected override void WriteValueToString(StringBuilder builder)
    {
        builder
            .Append("key byte=")
            .AppendFormatted(m_changeRequestByte, "X")
            .Append(", change address=")
            .Append(ChangeAddress)
            .Append(", change port=")
            .Append(ChangePort);
    }
}
