...
namespace SIPSorcery.Net
{
    public class SDP
    {
        ...
        /// <summary>
        /// Indicates multiple media offers will be bundled on a single RTP connection. Example: a=group:BUNDLE audio
        /// video
        /// </summary>
        public string Group;
        ...
        /// <summary>
        /// The stream status of this session. The default is sendrecv. If child media announcements have an explicit
        /// status set then they take precedence.
        /// </summary>
...
#nullable restore
        ...
        /// <returns>
        /// The media stream status set on the announcement or if there is none the session. If there is also no status
        /// set on the session then the default value of sendrecv is returned.
        /// </returns>
        ...
        /// <summary>
        /// Media announcements can be placed in SDP in any order BUT the orders must match up in offer/answer pairs.
        /// This method can be used to get the index for a specific media type. It is useful for obtaining the index of
        /// a particular media type when constructing an SDP answer.
        /// </summary>
        /// <returns></returns>
