...
public static class TypeExtensions
{
    ...
    public static string HexStr(this ReadOnlySpan<byte> buffer, char? separator = null, bool lowercase = false)
    {
        ...
        builder.Append(buffer, separator, lowercase);
    ...
    public static byte[] ParseHexStr(string hexStr)
    {
        ...
        if (hexStr.AsSpan().ContainsAny(SipSorcerySearchValues.DigitChars))
        {
        ...
        foreach (var tokenRange in chars.SplitAny(SipSorcerySearchValues.WhiteSpaceChars))
        {
